...
`prune-merged`) are a thin wrapper around a script — procedural
...
terminal, the reading copy of the release notes, and reaping the local branches a merge left behind).
