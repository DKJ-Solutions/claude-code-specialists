### Close three measurement gaps: entry scan, machine records, proposal path · Fix · 2026-07-29
...
[Sylvester's lens](.claude/plugins/claude-specialists/specialists/05-15-extension.md): when a gate checks
