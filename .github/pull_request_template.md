...
- [ ] `feat/` · new functionality (plugin, agent def, skill) · _enhancement_
- [ ] `fix/` · correction of an error in existing content · _bug_
- [ ] `docs/` · README, structure explanation, other documentation · _documentation_
