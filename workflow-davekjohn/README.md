...
| [`development-cycle.md`](development-cycle.md) | the branch's own document: its plan, and the DEPLOY section that folds into the changelog | [`DEVELOPMENT-CYCLE-portable.md`](../plugins/workflows/workflow-davekjohn/DEVELOPMENT-CYCLE-portable.md) |
