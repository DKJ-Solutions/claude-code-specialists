...
'@
    ...
    Assert-Match 'Summary: 0 error\(s\), 7 info signal\(s\)' $r.Out 'skip-reachability: only the deliberately-undefined seams remain (five original plus the two of the four issue #885 added that this repo still leaves undefined) -- the switch drops the reachability half and nothing else'
