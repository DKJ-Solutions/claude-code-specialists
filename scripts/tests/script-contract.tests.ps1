...
.SYNOPSIS
    ...
    (plugins/workflow-davekjohn/hooks/script-contract-sessioncheck.ps1).
...
$Hook          = Join-Path $RepoRoot 'plugins\workflow-davekjohn\hooks\script-contract-sessioncheck.ps1'
...
'@
    ...
    $cutReleaseSkillPath = Join-Path $RepoRoot 'plugins\workflow-davekjohn\skills\cut-release\SKILL.md'
