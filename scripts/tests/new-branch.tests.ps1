...
"@
    ...
    # pushed the commit, and the check under test prints them to a console. ONE OF TWO SUCH CONSOLES,
    # not the only one -- ship-pr relays a failing workflow's own annotation (Get-AuthoredFailureNote,
    # pr-issues-lib.ps1) and strips the same class since #1612, which pr-issues.tests.ps1 pins against
    # this one. The neighbouring adversarial case (a malicious -Title,
