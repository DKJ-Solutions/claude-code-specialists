...
# also be a CROSS-PLUGIN dependency -- this file ships in dkj-team-shopify, git-porcelain-lib in dkj-policy
# and, since #1689, in dkj-team-shopify too -- which sync-main.ps1 rules out by name for merged-pr-lib:
