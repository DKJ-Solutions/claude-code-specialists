...
| [`task/`](task/) | starting and parking work: the branch and its `contributing-davekjohn/<branch>.md` |
...
|---|---|---|
| [`task/new-branch.ps1`](task/new-branch.ps1) | creates the branch **and** its `contributing-davekjohn/<branch>.md`, in one move — a branch is never entry-less | `new-branch` |
...
4. **The step-list gate** — refuses while `contributing-davekjohn/<branch>.md` has an unresolved step above its DEPLOY heading. `ship-pr.ps1`
