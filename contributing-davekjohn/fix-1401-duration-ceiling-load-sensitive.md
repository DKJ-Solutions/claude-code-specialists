...
Issue #1401: replace the absolute <4s ceiling in test-suite-gate.tests.ps1 scenario 4b with a load-invariant comparison, per the file's own floor-vs-ceiling rule at line 240.
