...
are described in `CONTRIBUTING.md`.** Since August 14, 2026 that page is
deliberately the *standard workflow* — three rules, no entry, no fold, no cut — and it points at
[`workflow-davekjohn/CONTRIBUTING.md`](../../../../contributing-davekjohn/CONTRIBUTING.md) for exactly the mechanics
...
[`workflow-davekjohn/CLAUDE.md`](../../../../contributing-davekjohn/CONTRIBUTING.md) — the layer that applies on top and wins on conflict.
It is the same split `CONTRIBUTING.md` has made since August 14, 2026, extended
