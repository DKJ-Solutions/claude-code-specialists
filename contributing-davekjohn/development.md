...
Issue #1191: both passes match $mergedHeads by NAME. Next: switch the gh lookup to headRefName+headRefOid and require the tip to match, in both the local and the remote pass.
