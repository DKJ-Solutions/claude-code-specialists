...
INSTALL.md and ADOPTION.md name the enabled-but-not-installed state, give a verification that does not need the plugin, and say that all four detectors for it ship inside the plugin that is not loading (inbound #1076)
