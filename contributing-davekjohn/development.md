...
Issue #1151: add one clause to Test-ReleaseBumpEarned's major refusal naming Get-ReleaseMajorMinMinors, mirror to the plugin, extend release-lib.tests.ps1.
