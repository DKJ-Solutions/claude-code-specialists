...
Issue #1156: cut-release step 4 points at open-pr, which refuses on main. Adding -GatesOnly to open-pr.ps1 via a shared Invoke-WorkflowGates in gate-lib.ps1.
