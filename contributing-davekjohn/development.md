...
build the register proposal from the enabled plugin list rather than from the lens inventory, so a plugin that ships no agents/ still gets a row -- with an empty extensions array (inbound #1084)
