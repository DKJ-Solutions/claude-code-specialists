...
Inbound #1094: the permission rule, the tracker-search rule and the verify-an-inferred-constraint rule all live only in Chris's persona and the agent-def bodies, neither of which a pre-bootstrap main loop has.
