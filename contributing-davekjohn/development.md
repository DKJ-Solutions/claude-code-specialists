...
Answering inbound #1107: option 1, relocated from the body to the description, because the body is only read after an invocation that already loads Chris in full.
