...
Fix #1140: the comment above the Test-ReleaseBumpEarned call states the pre-August-7 ladder. Replace it with a pointer plus the outline, and say why it is not restated.
