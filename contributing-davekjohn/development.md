...
name the one direct-to-trunk commit every adoption has to make, and why it is not a choice: new-branch needs the branch lib the bootstrap writes (inbound #1085)
