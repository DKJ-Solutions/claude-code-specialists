...
Issue #1255: every branch writes the same contributing-davekjohn/development.md, so every merge to main conflicts every other open PR -- measured 7 of 7 open branches.
