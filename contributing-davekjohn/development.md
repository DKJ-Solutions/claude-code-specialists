...
Three testrun-2 findings: #1098 (intro says ## where the fold writes ###), #1099 (root-stray scan reads any backticked heading as a branch declaration + the remedy misdirects), #1100 (generated release docs carry trailing whitespace the next gate run fails on).
