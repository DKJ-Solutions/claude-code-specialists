...
Root cause is ConvertTo-CheckTimestamp accepting 0001-01-01 as a real time; guard BOTH shapes (string and [datetime]) and range-check before the [int] cast at both sites in Get-CheckWaitReport. Closes #977.
