...
**The name IS the branch** — `fix/thing-v1` gets `contributing-davekjohn/fix-thing-v1.md`, slashes
...
gate, green standalone on the same commit seconds later, because `contributing-davekjohn/<branch>.md`
