...
> Repo-lens (claude-code-specialists) accompanying the portable playbook in the `team-alpha` plugin (`plugins/team-alpha/manuals/06-29-manual.md`). This file does not describe the craft, but which conclusions Marlowe red-teams in this repo.
