...
### The internal tier: a release summary for colleagues and employers
...
### Block a PR whose changelog entry still carries its scaffold wording
...
#### The internal note becomes the release body, at every release
...
#### The v3.2.0 highlights, edited for the reader who decides whether to update
...
#### A parked branch can be silently overtaken, and only one command shows it
...
#### The route for the two hand-written release documents, confirmed
...
#### The internal summary for v3.2.0
...
#### Drop the print-ready HTML from the highlights tier
