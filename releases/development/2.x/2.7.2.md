...
`.claude/specialists/lenses/05-06-extension.md` (Rendall's own repo lens) all
...
`.claude/specialists/lenses/05-06-extension.md` (the "Versioning & releases"
...
read:** `.claude/specialists/lenses/05-15-extension.md` names the GitHub
