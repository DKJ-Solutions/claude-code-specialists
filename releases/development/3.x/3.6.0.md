...
artifact**: 17 empty sections in `plugins/team-alpha/RELEASE.md`, 17 in its per-plugin `CHANGELOG.md`, 16
...
shared mirror under `plugins/team-alpha/scripts/lib/` was updated in the same commit.
...
`plugins/team-lifehub/agents/02-10-agent.md` pointing at `../../CLAUDE.md`, which is
...
`../../../CLAUDE.md` from `plugins/team-shopify/agents/` does resolve in the clone; it reaches the
...
One hard rule added to [Sylvester #15's portable manual](../../../plugins/team-alpha/manuals/05-15-manual.md):
