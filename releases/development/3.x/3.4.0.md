...
**The history keeps the wrong explanation.** `plugins/team-alpha/CHANGELOG.md` and the archived v3.2.0
...
**What moved into [`fold-changelog`](../../../plugins/workflow-davekjohn/skills/fold-changelog/SKILL.md).** The entry-file
...
**What moved into [`cut-release`](../../../plugins/workflow-davekjohn/skills/cut-release/SKILL.md).** The marketplace-cache
