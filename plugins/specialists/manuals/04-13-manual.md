...
> Part of the Claude Specialists — the portable playbook (plugin `specialists`). The specialist reads the repo-specific lens from `.claude/specialists/lenses/04-13-extension.md` (or the legacy path `.claude/extensions/04-13-extension.md`) of the consuming repo. Assigned by Chris, the Chief of Staff.
