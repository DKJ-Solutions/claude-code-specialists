...
> Part of the Claude Specialists — the portable playbook (plugin `team-lifehub`). The specialist reads the repo-specific lens from `.claude/specialists/lenses/04-03-extension.md` (or the legacy path `.claude/extensions/04-03-extension.md`) of the consuming repo. Assigned by Chris, the Chief of Staff.
