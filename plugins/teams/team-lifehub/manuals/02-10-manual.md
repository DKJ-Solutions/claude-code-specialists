...
> Part of the Claude Specialists — the portable playbook (plugin `team-lifehub`). The specialist reads the repo-specific lens from `.claude/specialists/lenses/02-10-extension.md` (or the legacy path `.claude/extensions/02-10-extension.md`) of the consuming repo. Assigned by Chris, the Chief of Staff.
