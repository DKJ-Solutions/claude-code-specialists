...
| [`check-branch-entry`](skills/check-branch-entry/SKILL.md) | the CI gate on the branch dossier — the same checks `open-pr` runs, where a hand-pushed branch cannot escape them |
