...
function Get-DefaultChangelogPath {
    ...
    return 'workflow-davekjohn/CHANGELOG.md'
}
...
function Get-DefaultReleaseHistoryPath {
    ...
    return 'workflow-davekjohn/releases/history.md'
}
...
function Get-DefaultReleaseDevelopmentNotesRoot {
    ...
    return 'workflow-davekjohn/releases/development'
}
...
function Get-DefaultReleaseGithubNotesRoot {
    ...
    return 'workflow-davekjohn/releases/github'
}
