...
current `contributing-davekjohn/development.md` reads. A plan that reads as current is not evidence that it is. The cheap checks
first:
...
**`contributing-davekjohn/development.md` and nothing else**, because what another device needs from
