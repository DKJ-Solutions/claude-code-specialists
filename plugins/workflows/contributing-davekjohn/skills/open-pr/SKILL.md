...
the DEPLOY section of `contributing-davekjohn/development/<branch>.md`. So the sentence is written **once**, when the branch is created
...
The entry is the DEPLOY section of `contributing-davekjohn/development/<branch>.md`, and the fold copies its text
