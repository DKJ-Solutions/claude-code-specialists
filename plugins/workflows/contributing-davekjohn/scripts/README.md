...
|---|---|---|
| `task/new-branch.ps1` | creates the branch AND writes its `contributing-davekjohn/development-cycle.md`, in one move — a branch is never entry-less | [`new-branch`](../skills/new-branch/SKILL.md) |
