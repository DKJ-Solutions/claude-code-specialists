...
directories the run cleans up (`lenses/`, then `dkj-team-alpha/`) were pruned, listed and tallied only under
...
> [the claude-code-specialists README](https://github.com/DaveKJohn/claude-code-specialists/blob/main/); this page zooms in on step 0, the one that
...
the requirement itself in the [claude-code-specialists README](https://github.com/DaveKJohn/claude-code-specialists/blob/main/).
