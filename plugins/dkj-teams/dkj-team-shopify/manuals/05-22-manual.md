...
> Part of the Claude Specialists — the portable playbook (plugin `dkj-team-shopify`). The specialist reads the repo-specific lens from `.claude/specialists/lenses/05-22-extension.md` (or the legacy path `.claude/extensions/05-22-extension.md`) of the consuming repo. Assigned by Chris, the Chief of Staff.
